...
import Logo from "../../public/logo-nettko.jpeg";
    ...
    <div className="bg-white pb-6 sm:pb-8 lg:pb-12">
      ...
      <section className="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div className="mb-8 flex flex-wrap justify-between md:mb-16">
          <div className="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
            ...
            <p className="max-w-md leading-relaxed text-gray-500 xl:text-lg">
              Onde você encontra gameplays de diversos jogos!
            </p>
          </div>
          ...
          <div className="mb-12 flex w-full md:mb-16 lg:w-2/3">
            <div className="relative left-12 top-12 z-10 -ml-12 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:left-16 md:top-16 lg:ml-0">
              <img
                src="https://wallpapers.com/images/high/assassin-s-creed-valhalla-warriors-r820rsdrw4e4d6fn.webp"
                loading="lazy"
            ...
            <div className="overflow-hidden rounded-lg bg-gray-100 shadow-lg">
              <img
                src="https://c4.wallpaperflare.com/wallpaper/918/114/504/the-evil-within-2-2017-games-4k-hd-wallpaper-preview.jpg"
                loading="lazy"
        ...
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
          {/* TODO: <div className="flex h-12 w-64 divide-x overflow-hidden rounded-lg border">
            <a
              href="#"
          ...
          <div className="flex items-center justify-center gap-4 lg:justify-start">
            {/* TODO: <span className="text-sm font-semibold uppercase tracking-widest text-gray-400 sm:text-base">
              Social
            </span>
